...
To create a new line of text, insert two spaces after every line in the `Rmd` file, then hit *ENTER*.
...
Accordingly, we write the eigenfunction of a spinless particle as the superposition of plane wave states of momentum (*π*) and energy (*E**j*) having amplitudes *a*(*π*, *E**j*) (from [\[1\]](https://arxiv.org/vc/quant-ph/papers/0607/0607001v1.pdf)).
$$  
\\phi n(r,t) =  
