...
params:
  lesson: "Lesson 9"
  title: "Working with time series and dates"  
...
<!-- ----------------------- image --------------------------- -->
<div align="center">
  <img src="img/lubridate.jpg" style=width:50%>
</div>
<!-- ----------------------- image --------------------------- -->
...
```{r}
ct <- Sys.time()  # get date and time from your current location 
ct
...
```{r}
# get the current time and date from your location   
now()
...
Force POSIX into numeric, which you can transform back later.  
```{r}
