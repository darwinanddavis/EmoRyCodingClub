...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = displ, y = hwy), color = "light blue") +
  my_theme
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = displ, y = hwy), color = "#000000") +
  my_theme
```
\  
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = displ, y = hwy, color = class), color = "#000000") +
  my_theme
```
\  
