...
params: 
  ...
  title: "Lesson 1: Intro to plotting data in R with ggplot"
---
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = displ, y = hwy), color = "#BB5C42") +
  my_theme
```
\  
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = displ, y = hwy, color = class), color = "#AE42BB") +
  my_theme
```
\  
