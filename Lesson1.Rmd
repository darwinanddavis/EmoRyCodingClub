...
# Functions and packages for `r params$lesson`    

```{r,eval=T, echo=F}
require(readr)
readLines("https://raw.githubusercontent.com/darwinanddavis/EmoRyCodingClub/master/functions_lesson1.txt")
readLines("https://raw.githubusercontent.com/darwinanddavis/EmoRyCodingClub/master/packages_lesson1.txt")
```
...
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = x, y = y)) + 
  my_theme # add variable defining your chosen theme  
...
```{r, eval = T}
ggplot(data = my_data) +  
  geom_point(mapping = aes(x = x, y = y), color = "light blue") +
  my_theme
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = x, y = y), color = "#000000") +
  my_theme
```
\  
...
```{r, eval = FALSE}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = x, y = y, color = class)) +
  my_theme
```
\  
...
```{r, eval = T}
ggplot(data = my_data) +
  geom_point(mapping = aes(x = x, y = y, size = 5)) +
  my_theme
```
\  
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = x, y = y, size = class)) +
  my_theme
```
\  
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = x, y = y, shape = class)) +
  my_theme
```
\  
...
```{r, eval = T}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = x, y = y, color = class), color = "#000000") +
  my_theme
```
\  
...
ggplot(data = nyc) + 
  geom_point(mapping = aes(x = neighbourhood_group, y = price, color =
                             neighbourhood_group), shape = 21, stroke = 1) +
  my_theme
```
...
ggplot(data = nyc) + 
  geom_point(mapping = aes(x = minimum_nights, y = price, 
                           color = neighbourhood_group), shape = 20, size = 3, stroke = 1) +
  my_theme
```
...
ggplot(data = nyc) + 
  geom_point(mapping = aes(x = availability_365, y = price, 
                           color = neighbourhood_group), shape = 21, stroke = 1) +
  my_theme
```
...
```{r, echo=F}
ggplot(data = my_data) + 
  geom_point(mapping = aes(x = x, y = y, color = color), shape = shape, stroke = stroke)
```
