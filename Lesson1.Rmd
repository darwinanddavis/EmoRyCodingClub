...
ggplot(data = nyc) + 
  geom_point(mapping = aes(x = neighbourhood_group, y = price, colour =
...
ggplot(data = nyc) + 
  geom_point(mapping = aes(x = minimum_nights, y = price, 
                           colour = neighbourhood_group), shape = 20, size = 3, stroke = 1) +
  my_theme
```
...
ggplot(data = nyc) + 
  geom_point(mapping = aes(x = availability_365, y = price, 
                           colour = neighbourhood_group), shape = 21, stroke = 1) +
  my_theme
```
