...
![Great power is pretty boring](https://raw.githubusercontent.com/darwinanddavis/EmoRyCodingClub/master/img/opm.png).

```{r, echo=FALSE, eval=F, message=F, warning=F, fig.align="center"}
# **If knitting to PDF, use the below code**
# long code lines within code chunks will sit properly in pdf output when document doesnt have images  
# **************** IMAGE NEEDS TO BE PNG *****************

# define variable containing url
pacman::p_load(png,RCurl)
url <- params$img1 # this is the img path as a character string, "www.yoursite/img/opm.png"    
