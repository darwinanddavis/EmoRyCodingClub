...
params:
  ...
  functions: "`read_html`,`html_node`,`html_attr`"
  packages: "`rvest`,`xml2`"      
# end inputs ---------------------------------------------------------------
...
This code srapes the urls from the below webpage, but inclues all possible urls.  
```{r}
...
Pulling and plotting images straight from a webpage  
