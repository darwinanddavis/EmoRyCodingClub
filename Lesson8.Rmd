...
First, we need some text data. As an exercise, since we're using strings, we're going to use the webpage content on using strings from the [R for Data Science textbook](https://r4ds.had.co.nz/strings.html) as our text sample.      
```{r, eval=T}
