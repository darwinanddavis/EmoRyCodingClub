...
params:
  ...
  functions: "`read_csv`, `read_delim`, `write_csv`, `complete`, `expand`, `spread`, `gather`"
  packages: "`readr`"      
  # end inputs ---------------------------------------------------------------
...
Recreate the below PDF using `RMarkdown` with the following conditions from the smaller NYC Airbnb dataset. The final PDF file [is here](https://raw.githubusercontent.com/darwinanddavis/EmoRyCodingClub/master/Lesson7_dofirst.pdf).  
...
* Accommodation less than $200 per night and between than 5 and 15 nights minimum  
* Show only the data structure of the raw data as a code output. No need to show the code output for how you subsetted the data.     
...
```
* Append the below code at the beginning of your `Rmd` file to suppress the package loading messages and warnings. Use a `{r, echo=T, eval=T, message=F}` header in the code chunk.     
```{r, echo=T, eval=T,message=F}
# install.packages("pacman")
suppressWarnings(require(pacman))
p_load(ggthemes,ggplot2,readr,dplyr)
```


<!-- ----------------------- image --------------------------- -->
<div align="center">
  <img src="img/lesson7_dofirst1.jpg" style=width:50%>
</div>
<!-- ----------------------- image --------------------------- -->
\    
...
<!-- ----------------------- image --------------------------- -->
<div align="center">
  <img src="img/lesson7_dofirst2.jpg" style=width:50%>
</div>
<!-- ----------------------- image --------------------------- -->
\    
