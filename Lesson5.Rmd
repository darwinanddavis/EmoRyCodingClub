...
Create reproducible HTML, PDF, and Word documents from R using `RMarkdown`. **[Download the `RMarkdown` template (right click > Save As)](https://github.com/darwinanddavis/EmoRyCodingClub/raw/master/Lesson5_rmd.Rmd).**        
